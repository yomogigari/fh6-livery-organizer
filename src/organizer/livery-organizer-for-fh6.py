...
OFFICIAL_VEHICLE_LIST_URL = "https://forza.net/fh6cars"
OFFICIAL_VEHICLE_LIST_UPDATED = "2026-08-13"

# Forza公式車種リストの表示用メタデータ。Car ID対応はローカル車両アセットと
# Car Ordinal情報を照合して固定し、実行時にネットワークアクセスは行いません。
# 値: Car ID -> (year, make, model, display_name)
OFFICIAL_VEHICLE_METADATA: dict[int, tuple[int, str, str, str]] = {
    247: (1969, 'Toyota', '2000GT', '1969 Toyota 2000GT'),
    249: (1962, 'Ferrari', '250 GTO', '1962 Ferrari 250 GTO'),
    251: (1954, 'Mercedes-Benz', '300 SL Coupé', '1954 Mercedes-Benz 300 SL Coupé'),
    253: (1994, 'Ferrari', 'F355 Berlinetta', '1994 Ferrari F355 Berlinetta'),
    255: (1992, 'Ferrari', '512 TR', '1992 Ferrari 512 TR'),
    260: (1973, 'Porsche', '911 Carrera RS', '1973 Porsche 911 Carrera RS'),
    261: (1995, 'Porsche', '911 GT2', '1995 Porsche 911 GT2'),
    262: (2004, 'Porsche', '911 GT3', '2004 Porsche 911 GT3'),
    265: (1982, 'Porsche', '911 Turbo 3.3', '1982 Porsche 911 Turbo 3.3'),
    268: (1989, 'Porsche', '944 Turbo', '1989 Porsche 944 Turbo'),
    269: (1987, 'Porsche', '959', '1987 Porsche 959'),
    281: (1968, 'Plymouth', 'Barracuda Formula S', '1968 Plymouth Barracuda Formula S'),
    289: (1969, 'Chevrolet', 'Camaro Super Sport Coupe', '1969 Chevrolet Camaro Super Sport Coupe'),
    292: (2003, 'Porsche', 'Carrera GT', '2003 Porsche Carrera GT'),
    295: (2003, 'Toyota', 'Celica Sport Specialty II', '2003 Toyota Celica Sport Specialty II'),
    296: (1998, 'TVR', 'Cerbera Speed 12', '1998 TVR Cerbera Speed 12'),
    299: (1970, 'Chevrolet', 'Chevelle Super Sport 454', '1970 Chevrolet Chevelle Super Sport 454'),
    302: (2004, 'Honda', 'Civic Type R', '2004 Honda Civic Type R'),
    306: (1965, 'Shelby', 'Cobra 427 S/C', '1965 Shelby Cobra 427 S/C'),
    309: (1995, 'Volkswagen', 'Corrado VR6', '1995 Volkswagen Corrado VR6'),
    312: (1967, 'Chevrolet', 'Corvette Stingray 427', '1967 Chevrolet Corvette Stingray 427'),
    314: (2002, 'Chevrolet', 'Corvette Z06', '2002 Chevrolet Corvette Z06'),
    315: (1970, 'Chevrolet', 'Corvette ZR-1', '1970 Chevrolet Corvette ZR-1'),
    316: (1988, 'Lamborghini', 'Countach LP5000 QV', '1988 Lamborghini Countach LP5000 QV'),
    320: (1991, 'Honda', 'CR-X SiR', '1991 Honda CR-X SiR'),
    323: (1992, 'Lancia', 'Delta HF Integrale EVO', '1992 Lancia Delta HF Integrale EVO'),
    324: (1999, 'Lamborghini', 'Diablo GTR', '1999 Lamborghini Diablo GTR'),
    325: (1997, 'Lamborghini', 'Diablo SV', '1997 Lamborghini Diablo SV'),
    326: (1969, 'Ferrari', 'Dino 246 GT', '1969 Ferrari Dino 246 GT'),
    327: (1995, 'Mitsubishi', 'Eclipse GSX', '1995 Mitsubishi Eclipse GSX'),
    333: (2002, 'Ferrari', 'Enzo Ferrari', '2002 Ferrari Enzo Ferrari'),
    336: (1961, 'Jaguar', 'E-type', '1961 Jaguar E-type'),
    338: (1997, 'McLaren', 'F1 GT', '1997 McLaren F1 GT'),
    340: (1987, 'Ferrari', 'F40', '1987 Ferrari F40'),
    342: (1995, 'Ferrari', 'F50', '1995 Ferrari F50'),
    343: (1969, 'Nissan', 'Fairlady Z 432', '1969 Nissan Fairlady Z 432'),
    344: (2003, 'Nissan', 'Fairlady Z', '2003 Nissan Fairlady Z'),
    345: (1994, 'Nissan', 'Fairlady Z Version S Twin Turbo', '1994 Nissan Fairlady Z Version S Twin Turbo'),
    348: (2005, 'Ford', 'GT', '2005 Ford GT'),
    353: (1992, 'Volkswagen', 'Golf Gti 16v Mk2', '1992 Volkswagen Golf Gti 16v Mk2'),
    357: (1997, 'Mitsubishi', 'GTO', '1997 Mitsubishi GTO'),
    358: (1984, 'Ferrari', '288 GTO', '1984 Ferrari 288 GTO'),
    363: (1998, 'Subaru', 'Impreza 22B-STi Version', '1998 Subaru Impreza 22B-STi Version'),
    364: (2004, 'Subaru', 'IMPREZA WRX STI', '2004 Subaru IMPREZA WRX STI'),
    365: (2005, 'Subaru', 'IMPREZA WRX STI', '2005 Subaru IMPREZA WRX STI'),
    368: (2001, 'Acura', 'Integra Type R', '2001 Acura Integra Type R'),
    374: (2006, 'Mitsubishi', 'Lancer Evolution IX MR', '2006 Mitsubishi Lancer Evolution IX MR'),
    378: (2004, 'Mitsubishi', 'Lancer Evolution VIII MR', '2004 Mitsubishi Lancer Evolution VIII MR'),
    379: (2005, 'Subaru', 'LEGACY B4 2.0 GT', '2005 Subaru LEGACY B4 2.0 GT'),
    382: (1997, 'BMW', 'M3', '1997 BMW M3'),
    383: (2005, 'BMW', 'M3', '2005 BMW M3'),
    391: (2004, 'Maserati', 'MC12', '2004 Maserati MC12'),
    398: (1995, 'Toyota', 'MR2 GT', '1995 Toyota MR2 GT'),
    405: (2000, 'Ford', 'Mustang SVT Cobra R', '2000 Ford Mustang SVT Cobra R'),
    411: (2005, 'Honda', 'NSX-R', '2005 Honda NSX-R'),
    412: (1992, 'Honda', 'NSX-R', '1992 Honda NSX-R'),
    417: (1987, 'Buick', 'Regal GNX', '1987 Buick Regal GNX'),
    419: (2006, 'Audi', 'RS 4', '2006 Audi RS 4'),
    420: (2003, 'Audi', 'RS 6', '2003 Audi RS 6'),
    422: (2002, 'Acura', 'RSX Type S', '2002 Acura RSX Type S'),
    423: (1990, 'Mazda', 'Savanna RX-7', '1990 Mazda Savanna RX-7'),
    427: (2003, 'Honda', 'S2000', '2003 Honda S2000'),
    433: (2005, 'TVR', 'Sagaris', '2005 TVR Sagaris'),
    440: (1994, 'Nissan', "Silvia K's", "1994 Nissan Silvia K's"),
    455: (1985, 'Toyota', 'Sprinter Trueno GT Apex', '1985 Toyota Sprinter Trueno GT Apex'),
    458: (1974, 'Lancia', 'Stratos HF Stradale', '1974 Lancia Stratos HF Stradale'),
    460: (1992, 'Toyota', 'Supra 2.0 GT', '1992 Toyota Supra 2.0 GT'),
    461: (1998, 'Toyota', 'Supra RZ', '1998 Toyota Supra RZ'),
    483: (1999, 'Dodge', 'Viper GTS ACR', '1999 Dodge Viper GTS ACR'),
    489: (1993, 'Jaguar', 'XJ220', '1993 Jaguar XJ220'),
    513: (1969, 'Dodge', 'Charger R/T', '1969 Dodge Charger R/T'),
    567: (1998, 'Nissan', 'R390 (GT1)', '1998 Nissan R390 (GT1)'),
    568: (1998, 'Mercedes-Benz', 'AMG CLK GTR', '1998 Mercedes-Benz AMG CLK GTR'),
    569: (2005, 'Honda', 'NSX-R GT', '2005 Honda NSX-R GT'),
    615: (2007, 'Peugeot', '207 Super 2000', '2007 Peugeot 207 Super 2000'),
    625: (2007, 'Honda', 'Civic Type R', '2007 Honda Civic Type R'),
    633: (1984, 'Audi', 'Sport quattro', '1984 Audi Sport quattro'),
    634: (1980, 'Renault', '5 Turbo', '1980 Renault 5 Turbo'),
    637: (1967, 'Lamborghini', 'Miura P400', '1967 Lamborghini Miura P400'),
    639: (1970, 'Dodge', 'Challenger R/T', '1970 Dodge Challenger R/T'),
    641: (1997, 'Porsche', '911 GT1 Strassenversion', '1997 Porsche 911 GT1 Strassenversion'),
    1006: (2005, 'Ferrari', 'FXX', '2005 Ferrari FXX'),
    1007: (2008, 'Koenigsegg', 'CCGT', '2008 Koenigsegg CCGT'),
    1009: (2008, 'Mitsubishi', 'Lancer Evolution X GSR', '2008 Mitsubishi Lancer Evolution X GSR'),
    1011: (2008, 'BMW', 'M3', '2008 BMW M3'),
    1020: (1996, 'Ferrari', 'F50 GT', '1996 Ferrari F50 GT'),
    1022: (2007, 'Ferrari', '430 Scuderia', '2007 Ferrari 430 Scuderia'),
    1023: (1989, 'Ferrari', 'F40 Competizione', '1989 Ferrari F40 Competizione'),
    1032: (2007, 'Alfa Romeo', '8C Competizione', '2007 Alfa Romeo 8C Competizione'),
    1034: (1994, 'Toyota', 'Celica GT-Four ST205', '1994 Toyota Celica GT-Four ST205'),
    1040: (1981, 'BMW', 'M1', '1981 BMW M1'),
    1041: (1993, 'Ford', 'Mustang SVT Cobra R', '1993 Ford Mustang SVT Cobra R'),
    1042: (1971, 'Nissan', 'Skyline 2000GT-R', '1971 Nissan Skyline 2000GT-R'),
    1045: (1987, 'Pontiac', 'Firebird Trans Am GTA', '1987 Pontiac Firebird Trans Am GTA'),
    1046: (2008, 'Dodge', 'Viper SRT-10 ACR', '2008 Dodge Viper SRT-10 ACR'),
    1052: (2006, 'Dodge', 'Ram SRT-10', '2006 Dodge Ram SRT-10'),
    1059: (2008, 'BMW', 'Z4 M Coupé', '2008 BMW Z4 M Coupé'),
    1060: (2008, 'Subaru', 'IMPREZA WRX STI', '2008 Subaru IMPREZA WRX STI'),
    1063: (1969, 'Dodge', 'Charger Daytona HEMI', '1969 Dodge Charger Daytona HEMI'),
    1064: (1979, 'Chevrolet', 'Camaro Z28', '1979 Chevrolet Camaro Z28'),
    1069: (2009, 'Chevrolet', 'Corvette ZR1', '2009 Chevrolet Corvette ZR1'),
    1086: (2009, 'Ford', 'Focus RS', '2009 Ford Focus RS'),
    1090: (2009, 'Mercedes-Benz', 'SL 65 AMG Black Series', '2009 Mercedes-Benz SL 65 AMG Black Series'),
    1093: (1960, 'Chevrolet', 'Corvette', '1960 Chevrolet Corvette'),
    1103: (2010, 'Nissan', '370Z', '2010 Nissan 370Z'),
    1104: (1970, 'Datsun', '510', '1970 Datsun 510'),
    1105: (1964, 'Aston Martin', 'DB5', '1964 Aston Martin DB5'),
    1108: (1985, 'Ford', 'RS200 Evolution', '1985 Ford RS200 Evolution'),
    1110: (1994, 'Mazda', 'MX-5 Miata', '1994 Mazda MX-5 Miata'),
    1124: (1980, 'Abarth', 'Fiat 131', '1980 Abarth Fiat 131'),
    1126: (2009, 'BMW', 'M5', '2009 BMW M5'),
    1130: (2011, 'McLaren', '12C Coupé', '2011 McLaren 12C Coupé'),
    1131: (2009, 'Ferrari', '458 Italia', '2009 Ferrari 458 Italia'),
    1150: (1965, 'Alfa Romeo', 'Giulia Sprint GTA Stradale', '1965 Alfa Romeo Giulia Sprint GTA Stradale'),
    1155: (1965, 'Shelby', 'Cobra Daytona Coupe', '1965 Shelby Cobra Daytona Coupe'),
    1171: (2010, 'Ferrari', '599XX', '2010 Ferrari 599XX'),
    1173: (2010, 'Lamborghini', 'Murciélago LP 670-4 SV', '2010 Lamborghini Murciélago LP 670-4 SV'),
    1175: (2009, 'Pagani', 'Zonda R', '2009 Pagani Zonda R'),
    1184: (2009, 'Audi', 'RS 6', '2009 Audi RS 6'),
    1200: (2009, 'Audi', 'R8 LMS', '2009 Audi R8 LMS'),
    1204: (2010, 'Renault', 'Megane RS 250', '2010 Renault Megane RS 250'),
    1216: (2011, 'Audi', 'RS 3 Sportback', '2011 Audi RS 3 Sportback'),
    1220: (2010, 'Audi', 'TT RS Coupé', '2010 Audi TT RS Coupé'),
    1221: (2010, 'Mazda', 'Mazdaspeed 3', '2010 Mazda Mazdaspeed 3'),
    1229: (2008, 'Mazda', 'Furai', '2008 Mazda Furai'),
    1231: (2010, 'Volkswagen', 'Golf R', '2010 Volkswagen Golf R'),
    1253: (2010, 'Noble', 'M600', '2010 Noble M600'),
    1260: (2010, 'Lexus', 'LFA', '2010 Lexus LFA'),
    1269: (1973, 'BMW', '2002 Turbo', '1973 BMW 2002 Turbo'),
    1270: (1982, 'DeLorean', 'DMC-12', '1982 DeLorean DMC-12'),
    1272: (1992, 'Ford', 'Escort RS Cosworth', '1992 Ford Escort RS Cosworth'),
    1273: (1997, 'Honda', 'Civic Type R', '1997 Honda Civic Type R'),
    1276: (1977, 'Pontiac', 'Firebird Trans Am', '1977 Pontiac Firebird Trans Am'),
    1277: (1971, 'Plymouth', 'Cuda 426 HEMI', '1971 Plymouth Cuda 426 HEMI'),
    1278: (1973, 'Ford', 'XB Falcon GT', '1973 Ford XB Falcon GT'),
    1282: (1993, 'Nissan', '240SX', '1993 Nissan 240SX'),
    1283: (1957, 'Ford', 'Thunderbird', '1957 Ford Thunderbird'),
    1291: (1970, 'Chevrolet', 'El Camino Super Sport 454', '1970 Chevrolet El Camino Super Sport 454'),
    1293: (1987, 'Ford', 'Sierra Cosworth RS500', '1987 Ford Sierra Cosworth RS500'),
    1294: (1991, 'GMC', 'Syclone', '1991 GMC Syclone'),
    1295: (1982, 'Lancia', '037 Stradale', '1982 Lancia 037 Stradale'),
    1296: (1990, 'Mercedes-Benz', '190 E 2.5-16 Evolution II', '1990 Mercedes-Benz 190 E 2.5-16 Evolution II'),
    1297: (1988, 'Mitsubishi', 'Starion ESI-R', '1988 Mitsubishi Starion ESI-R'),
    1299: (1983, 'Volvo', '242 Turbo Evolution', '1983 Volvo 242 Turbo Evolution'),
    1300: (1964, 'Chevrolet', 'Impala Super Sport 409', '1964 Chevrolet Impala Super Sport 409'),
    1301: (1956, 'Jaguar', 'D-Type', '1956 Jaguar D-Type'),
    1314: (1993, 'McLaren', 'F1', '1993 McLaren F1'),
    1323: (2011, 'Subaru', 'WRX STI', '2011 Subaru WRX STI'),
    1330: (1970, 'Chevrolet', 'Camaro Z28', '1970 Chevrolet Camaro Z28'),
    1332: (1968, 'Dodge', 'Dart HEMI Super Stock', '1968 Dodge Dart HEMI Super Stock'),
    1335: (1991, 'Mazda', '#55 Mazda 787B', '1991 Mazda #55 Mazda 787B'),
    1350: (2011, 'BMW', 'X5 M', '2011 BMW X5 M'),
    1352: (1970, 'Dodge', 'Coronet Super Bee', '1970 Dodge Coronet Super Bee'),
    1355: (1965, 'Ford', 'Mustang GT Coupe', '1965 Ford Mustang GT Coupe'),
    1367: (2003, 'BMW', 'M5', '2003 BMW M5'),
    1368: (1988, 'BMW', 'M5', '1988 BMW M5'),
    1369: (2010, 'Pagani', 'Zonda Cinque Roadster', '2010 Pagani Zonda Cinque Roadster'),
    1376: (1999, 'Lotus', 'Elise Series 1 Sport 190', '1999 Lotus Elise Series 1 Sport 190'),
    1379: (1996, 'Chevrolet', 'Impala Super Sport', '1996 Chevrolet Impala Super Sport'),
    1381: (1992, 'Mitsubishi', 'Galant VR-4', '1992 Mitsubishi Galant VR-4'),
    1382: (1990, 'Subaru', 'LEGACY RS', '1990 Subaru LEGACY RS'),
    1388: (2012, 'BMW', 'M5', '2012 BMW M5'),
    1392: (2011, 'Lamborghini', 'Sesto Elemento', '2011 Lamborghini Sesto Elemento'),
    1393: (1992, 'Alfa Romeo', '155 Q4', '1992 Alfa Romeo 155 Q4'),
    1394: (1992, 'GMC', 'Typhoon', '1992 GMC Typhoon'),
    1395: (1989, 'Toyota', 'MR2 SC', '1989 Toyota MR2 SC'),
    1397: (2011, 'Koenigsegg', 'Agera', '2011 Koenigsegg Agera'),
    1398: (2012, 'Lamborghini', 'Aventador LP700-4', '2012 Lamborghini Aventador LP700-4'),
    1417: (2011, 'Audi', 'RS 5 Coupé', '2011 Audi RS 5 Coupé'),
    1418: (1995, 'BMW', 'M5', '1995 BMW M5'),
    1426: (2011, 'Mazda', 'RX-8 R3', '2011 Mazda RX-8 R3'),
    1428: (2011, 'Volkswagen', 'Scirocco R', '2011 Volkswagen Scirocco R'),
    1429: (1969, 'Chevrolet', 'Nova Super Sport 396', '1969 Chevrolet Nova Super Sport 396'),
    1435: (1963, 'Volkswagen', 'Beetle', '1963 Volkswagen Beetle'),
    1459: (1957, 'Chevrolet', 'Bel Air', '1957 Chevrolet Bel Air'),
    1477: (2011, 'Ford', 'Transit SuperSportVan', '2011 Ford Transit SuperSportVan'),
    1478: (1986, 'Audi', '#2 Audi Sport quattro S1', '1986 Audi #2 Audi Sport quattro S1'),
    1480: (1985, 'Mazda', 'RX-7 GSL-SE', '1985 Mazda RX-7 GSL-SE'),
    1481: (1965, 'Austin-Healey', '3000 MkIII', '1965 Austin-Healey 3000 MkIII'),
    1493: (1995, 'BMW', '850CSi', '1995 BMW 850CSi'),
    1500: (2012, 'Mercedes-Benz', 'C 63 AMG Coupé Black Series', '2012 Mercedes-Benz C 63 AMG Coupé Black Series'),
    1513: (1997, 'Maserati', 'Ghibli Cup', '1997 Maserati Ghibli Cup'),
    1514: (1973, 'Mazda', 'RX-3', '1973 Mazda RX-3'),
    1517: (1992, 'Toyota', 'Celica GT-Four RC ST185', '1992 Toyota Celica GT-Four RC ST185'),
    1522: (2012, 'Jeep', 'Wrangler Rubicon', '2012 Jeep Wrangler Rubicon'),
    1529: (1973, 'Ford', 'Capri RS3100', '1973 Ford Capri RS3100'),
    1532: (2012, 'Hennessey', 'Venom GT', '2012 Hennessey Venom GT'),
    1533: (1977, 'Holden', 'Torana A9X', '1977 Holden Torana A9X'),
    1537: (1974, 'Toyota', 'Corolla SR5', '1974 Toyota Corolla SR5'),
    1549: (1968, 'Alfa Romeo', '33 Stradale', '1968 Alfa Romeo 33 Stradale'),
    1559: (1955, 'Mercedes-Benz', '300 SLR', '1955 Mercedes-Benz 300 SLR'),
    1562: (2013, 'SRT', 'Viper GTS', '2013 SRT Viper GTS'),
    1564: (1953, 'Chevrolet', 'Corvette', '1953 Chevrolet Corvette'),
    1568: (1974, 'Honda', 'Civic RS', '1974 Honda Civic RS'),
    1575: (1988, 'Chevrolet', 'Monte Carlo Super Sport', '1988 Chevrolet Monte Carlo Super Sport'),
    1578: (1962, 'Ferrari', '250 GT Berlinetta Lusso', '1962 Ferrari 250 GT Berlinetta Lusso'),
    1586: (1962, 'Lincoln', 'Continental', '1962 Lincoln Continental'),
    1587: (1972, 'Mazda', 'Cosmo 110S Series II', '1972 Mazda Cosmo 110S Series II'),
    1591: (1984, 'Peugeot', '205 Turbo 16', '1984 Peugeot 205 Turbo 16'),
    1592: (1974, 'Toyota', 'Celica GT', '1974 Toyota Celica GT'),
    1598: (2010, 'BMW', 'M3 GTS', '2010 BMW M3 GTS'),
    1599: (2012, 'Ferrari', '599XX Evolution', '2012 Ferrari 599XX Evolution'),
    1601: (2012, 'Lamborghini', 'Gallardo LP570-4 Spyder Performante', '2012 Lamborghini Gallardo LP570-4 Spyder Performante'),
    1607: (2013, 'Audi', 'RS 4 Avant', '2013 Audi RS 4 Avant'),
    1627: (2013, 'Mercedes-Benz', 'G 65 AMG', '2013 Mercedes-Benz G 65 AMG'),
    1650: (1986, 'Honda', 'Civic Si', '1986 Honda Civic Si'),
    1651: (2013, 'Ariel', 'Atom 500 V8', '2013 Ariel Atom 500 V8'),
    1654: (2013, 'Ford', 'Mustang Shelby GT500', '2013 Ford Mustang Shelby GT500'),
    1655: (2013, 'Subaru', 'BRZ', '2013 Subaru BRZ'),
    1658: (2013, 'Mercedes-Benz', 'A 45 AMG', '2013 Mercedes-Benz A 45 AMG'),
    1661: (1986, 'Lancia', 'Delta S4', '1986 Lancia Delta S4'),
    1662: (1965, 'MINI', 'Cooper S', '1965 MINI Cooper S'),
    1667: (2013, 'McLaren', 'P1', '2013 McLaren P1'),
    1668: (1969, 'Ford', 'Mustang Boss 302', '1969 Ford Mustang Boss 302'),
    2002: (2012, 'Nissan', 'GT-R Black Edition (R35)', '2012 Nissan GT-R Black Edition (R35)'),
    2003: (2012, 'MINI', 'John Cooper Works GP', '2012 MINI John Cooper Works GP'),
    2004: (2013, 'Mazda', 'MX-5', '2013 Mazda MX-5'),
    2006: (1995, 'Chevrolet', 'Corvette ZR-1', '1995 Chevrolet Corvette ZR-1'),
    2007: (2013, 'Toyota', '86', '2013 Toyota 86'),
    2009: (2013, 'Audi', 'RS 7 Sportback', '2013 Audi RS 7 Sportback'),
    2010: (2013, 'Audi', 'R8 Coupé V10 plus 5.2 FSI quattro', '2013 Audi R8 Coupé V10 plus 5.2 FSI quattro'),
    2017: (1968, 'Abarth', '595 esseesse', '1968 Abarth 595 esseesse'),
    2019: (2003, 'Ford', 'Focus RS', '2003 Ford Focus RS'),
    2034: (2013, 'Ferrari', 'LaFerrari', '2013 Ferrari LaFerrari'),
    2038: (2014, 'Alfa Romeo', '4C', '2014 Alfa Romeo 4C'),
    2040: (2014, 'BAC', 'Mono', '2014 BAC Mono'),
    2042: (2013, 'Lamborghini', 'Veneno', '2013 Lamborghini Veneno'),
    2119: (1984, 'Honda', 'Civic CRX Mugen', '1984 Honda Civic CRX Mugen'),
    2121: (1994, 'Honda', 'Prelude Si', '1994 Honda Prelude Si'),
    2128: (2013, 'Cadillac', 'XTS Limousine', '2013 Cadillac XTS Limousine'),
    2131: (2014, 'HSV', 'GEN-F GTS', '2014 HSV GEN-F GTS'),
    2133: (2015, 'BMW', 'i8', '2015 BMW i8'),
    2140: (1980, 'Subaru', 'BRAT GL', '1980 Subaru BRAT GL'),
    2142: (2014, 'Volkswagen', 'Golf R', '2014 Volkswagen Golf R'),
    2145: (2014, 'Ford', 'Ranger T6 Rally Raid', '2014 Ford Ranger T6 Rally Raid'),
    2147: (1986, 'MG', 'Metro 6R4', '1986 MG Metro 6R4'),
    2148: (2013, 'MINI', 'X-Raid All4 Racing Countryman', '2013 MINI X-Raid All4 Racing Countryman'),
    2149: (1993, 'Renault', 'Clio Williams', '1993 Renault Clio Williams'),
    2151: (1963, 'Volkswagen', 'Type 2 De Luxe', '1963 Volkswagen Type 2 De Luxe'),
    2154: (2014, 'BMW', 'M4 Coupé', '2014 BMW M4 Coupé'),
    2161: (1965, 'Alfa Romeo', 'Giulia TZ2', '1965 Alfa Romeo Giulia TZ2'),
    2163: (2015, 'Honda', 'Civic Type R', '2015 Honda Civic Type R'),
    2164: (2014, 'Lamborghini', 'Huracán LP 610-4', '2014 Lamborghini Huracán LP 610-4'),
    2168: (2015, 'Subaru', 'WRX STI', '2015 Subaru WRX STI'),
    2171: (2005, 'Mazda', 'Mazdaspeed MX-5', '2005 Mazda Mazdaspeed MX-5'),
    2175: (2015, 'Lexus', 'RC F', '2015 Lexus RC F'),
    2177: (2015, 'Chevrolet', 'Corvette Z06', '2015 Chevrolet Corvette Z06'),
    2178: (2001, 'Audi', 'RS 4 Avant', '2001 Audi RS 4 Avant'),
    2179: (2015, 'Audi', 'S1', '2015 Audi S1'),
    2180: (2015, 'Audi', 'RS 6 Avant', '2015 Audi RS 6 Avant'),
    2183: (2015, 'Chevrolet', 'Camaro Z/28', '2015 Chevrolet Camaro Z/28'),
    2184: (2013, 'Ferrari', '458 Speciale', '2013 Ferrari 458 Speciale'),
    2188: (2015, 'Koenigsegg', 'One:1', '2015 Koenigsegg One:1'),
    2205: (1970, 'Honda', 'S800', '1970 Honda S800'),
    2216: (1958, 'Plymouth', 'Fury', '1958 Plymouth Fury'),
    2217: (1996, 'Subaru', 'SVX', '1996 Subaru SVX'),
    2242: (2015, 'Mercedes-AMG', 'GT S', '2015 Mercedes-AMG GT S'),
    2262: (2016, 'Cadillac', 'ATS-V', '2016 Cadillac ATS-V'),
    2263: (2015, 'Dodge', 'Challenger SRT Hellcat', '2015 Dodge Challenger SRT Hellcat'),
    2267: (2016, 'Mazda', 'MX-5', '2016 Mazda MX-5'),
    2270: (1973, 'Nissan', 'Skyline H/T 2000GT-R', '1973 Nissan Skyline H/T 2000GT-R'),
    2272: (1969, 'Datsun', '2000 Roadster', '1969 Datsun 2000 Roadster'),
    2290: (2014, 'Porsche', '918 Spyder', '2014 Porsche 918 Spyder'),
    2297: (2012, 'Porsche', '911 GT3 RS 4.0', '2012 Porsche 911 GT3 RS 4.0'),
    2357: (2017, 'Ford', 'Focus RS', '2017 Ford Focus RS'),
    2363: (2017, 'Ford', 'GT', '2017 Ford GT'),
    2371: (2014, 'Ferrari', 'FXX K', '2014 Ferrari FXX K'),
    2372: (1932, 'Ford', 'De Luxe Five-Window Coupe', '1932 Ford De Luxe Five-Window Coupe'),
    2400: (2016, 'Ford', 'Mustang Shelby GT350R', '2016 Ford Mustang Shelby GT350R'),
    2412: (1957, 'BMW', 'Isetta 300 Export', '1957 BMW Isetta 300 Export'),
    2416: (1971, 'Meyers', 'Manx', '1971 Meyers Manx'),
    2420: (1984, 'Opel', 'Manta 400', '1984 Opel Manta 400'),
    2421: (2016, 'Cadillac', 'CTS-V Sedan', '2016 Cadillac CTS-V Sedan'),
    2422: (2014, 'HSV', 'Limited Edition GEN-F GTS Maloo', '2014 HSV Limited Edition GEN-F GTS Maloo'),
    2430: (2016, 'Ariel', 'Nomad', '2016 Ariel Nomad'),
    2467: (2015, 'Ferrari', '488 GTB', '2015 Ferrari 488 GTB'),
    2468: (2015, 'Dodge', 'Charger SRT Hellcat', '2015 Dodge Charger SRT Hellcat'),
    2469: (1965, 'Toyota', 'Sports 800', '1965 Toyota Sports 800'),
    2470: (2016, 'Aston Martin', 'Vulcan', '2016 Aston Martin Vulcan'),
    2471: (2016, 'Mercedes-AMG', 'C 63 S Coupé', '2016 Mercedes-AMG C 63 S Coupé'),
    2472: (2015, 'McLaren', '570S Coupé', '2015 McLaren 570S Coupé'),
    2473: (2016, 'Audi', 'R8 V10 plus', '2016 Audi R8 V10 plus'),
    2486: (2015, 'Radical', 'RXC Turbo', '2015 Radical RXC Turbo'),
    2489: (2016, 'Abarth', '695 Biposto', '2016 Abarth 695 Biposto'),
    2494: (2015, 'Land Rover', 'Range Rover Sport SVR', '2015 Land Rover Range Rover Sport SVR'),
    2507: (1955, 'Chevrolet', '150 Utility Sedan', '1955 Chevrolet 150 Utility Sedan'),
    2512: (1987, 'Nissan', 'Skyline GTS-R', '1987 Nissan Skyline GTS-R'),
    2515: (2011, 'Penhall', 'The Cholla', '2011 Penhall The Cholla'),
    2517: (2014, 'Ford', '#11 Rockstar F-150 Trophy Truck', '2014 Ford #11 Rockstar F-150 Trophy Truck'),
    2526: (2016, 'Koenigsegg', 'Regera', '2016 Koenigsegg Regera'),
    2527: (2017, 'Aston Martin', 'DB11', '2017 Aston Martin DB11'),
    2534: (1993, 'Porsche', '968 Turbo S', '1993 Porsche 968 Turbo S'),
    2535: (1993, 'Porsche', '928 GTS', '1993 Porsche 928 GTS'),
    2542: (2017, 'Alfa Romeo', 'Giulia Quadrifoglio', '2017 Alfa Romeo Giulia Quadrifoglio'),
    2544: (2016, 'Dodge', 'Viper ACR', '2016 Dodge Viper ACR'),
    2549: (1970, 'Porsche', '#3 917 LH', '1970 Porsche #3 917 LH'),
    2551: (2014, 'Ford', 'FPV Limited Edition Pursuit Ute', '2014 Ford FPV Limited Edition Pursuit Ute'),
    2552: (2015, 'Alumicraft', 'Class 10 Race Car', '2015 Alumicraft Class 10 Race Car'),
    2563: (1972, 'Reliant', 'Supervan III', '1972 Reliant Supervan III'),
    2566: (1979, 'Toyota', 'FJ40', '1979 Toyota FJ40'),
    2568: (1969, 'Volkswagen', 'Class 5/1600 Baja Bug', '1969 Volkswagen Class 5/1600 Baja Bug'),
    2569: (2015, 'Ultima', 'Evolution Coupe 1020', '2015 Ultima Evolution Coupe 1020'),
    2574: (2554, 'AMG Transport Dynamics', 'M12S Warthog CST', '2554 AMG Transport Dynamics M12S Warthog CST'),
    2577: (2015, 'Ferrari', 'F12tdf', '2015 Ferrari F12tdf'),
    2613: (1970, 'GMC', 'Jimmy', '1970 GMC Jimmy'),
    2614: (1968, 'Ford', 'Mustang GT 2+2 Fastback', '1968 Ford Mustang GT 2+2 Fastback'),
    2616: (2016, 'Lamborghini', 'Centenario LP 770-4', '2016 Lamborghini Centenario LP 770-4'),
    2618: (2017, 'Nissan', 'GT-R (R35)', '2017 Nissan GT-R (R35)'),
    2625: (2016, 'Bentley', 'Bentayga', '2016 Bentley Bentayga'),
    2628: (2016, 'BMW', 'M4 GTS', '2016 BMW M4 GTS'),
    2636: (1993, 'Toyota', '#1 T100 Baja Truck', '1993 Toyota #1 T100 Baja Truck'),
    2647: (2016, 'Pagani', 'Huayra BC Coupe', '2016 Pagani Huayra BC Coupe'),
    2649: (2010, 'Ford', 'Crown Victoria Police Interceptor', '2010 Ford Crown Victoria Police Interceptor'),
    2652: (1997, 'Mitsubishi', 'Montero Evolution', '1997 Mitsubishi Montero Evolution'),
    2654: (2017, 'Mercedes-AMG', 'GT R', '2017 Mercedes-AMG GT R'),
    2659: (1998, 'Nissan', "Silvia K's Aero", "1998 Nissan Silvia K's Aero"),
    2663: (2016, 'RJ Anderson', '#37 Polaris RZR Pro 2 Truck', '2016 RJ Anderson #37 Polaris RZR Pro 2 Truck'),
    2738: (1995, 'Nissan', 'NISMO GT-R LM', '1995 Nissan NISMO GT-R LM'),
    2739: (2017, 'Chevrolet', 'Camaro ZL1', '2017 Chevrolet Camaro ZL1'),
    2740: (2017, 'Abarth', '124 Spider', '2017 Abarth 124 Spider'),
    2742: (2016, 'Jeep', 'Trailcat', '2016 Jeep Trailcat'),
    2743: (2016, 'Toyota', 'Land Cruiser Arctic Trucks AT37', '2016 Toyota Land Cruiser Arctic Trucks AT37'),
    2745: (2015, 'Honda', 'Ridgeline Baja Trophy Truck', '2015 Honda Ridgeline Baja Trophy Truck'),
    2755: (2018, 'Porsche', '911 GT2 RS', '2018 Porsche 911 GT2 RS'),
    2773: (2018, 'Porsche', 'Cayenne Turbo', '2018 Porsche Cayenne Turbo'),
    2792: (1966, 'Ford', '#2 GT40 Mk II', '1966 Ford #2 GT40 Mk II'),
    2793: (1967, 'Ferrari', '#24 Ferrari Spa 330 P4', '1967 Ferrari #24 Ferrari Spa 330 P4'),
    2794: (1993, 'Porsche', '911 Turbo S Leichtbau', '1993 Porsche 911 Turbo S Leichtbau'),
    2801: (1983, 'Nissan', '#11 Tomica Skyline Turbo Super Silhouette', '1983 Nissan #11 Tomica Skyline Turbo Super Silhouette'),
    2822: (1985, 'Nissan', 'Safari Turbo', '1985 Nissan Safari Turbo'),
    2825: (1997, 'Lotus', 'Elise GT1', '1997 Lotus Elise GT1'),
    2841: (2018, 'Jeep', 'Grand Cherokee Trackhawk', '2018 Jeep Grand Cherokee Trackhawk'),
    2866: (2018, 'Exomotive', 'Exocet Sport V8 XP-5', '2018 Exomotive Exocet Sport V8 XP-5'),
    2870: (2018, 'Honda', 'Civic Type R', '2018 Honda Civic Type R'),
    2871: (2018, 'Can-Am', 'Maverick X RS Turbo R', '2018 Can-Am Maverick X RS Turbo R'),
    2872: (2019, 'Hyundai', 'Veloster N', '2019 Hyundai Veloster N'),
    2909: (2018, 'Dodge', 'Challenger SRT Demon', '2018 Dodge Challenger SRT Demon'),
    2910: (2017, 'Koenigsegg', 'Agera RS', '2017 Koenigsegg Agera RS'),
    2935: (2018, 'Funco Motorsports', 'F9', '2018 Funco Motorsports F9'),
    2937: (2017, 'Ford', '#14 Rahal Letterman Lanigan Racing Fiesta', '2017 Ford #14 Rahal Letterman Lanigan Racing Fiesta'),
    2968: (2023, 'Aston Martin', 'Valkyrie', '2023 Aston Martin Valkyrie'),
    2974: (2017, 'Ferrari', '812 Superfast', '2017 Ferrari 812 Superfast'),
    2986: (2014, 'Mercedes-Benz', 'Unimog U5023', '2014 Mercedes-Benz Unimog U5023'),
    2987: (1962, 'Peel', 'P50', '1962 Peel P50'),
    2992: (1964, 'Jaguar', 'Lightweight E-Type', '1964 Jaguar Lightweight E-Type'),
    2993: (2018, 'TVR', 'Griffith', '2018 TVR Griffith'),
    2995: (1983, 'Volkswagen', 'Golf GTI', '1983 Volkswagen Golf GTI'),
    2996: (2015, 'Formula Drift', '#13 Ford Mustang', '2015 Formula Drift #13 Ford Mustang'),
    2997: (2016, 'Formula Drift', '#530 HSV Maloo GEN-F', '2016 Formula Drift #530 HSV Maloo GEN-F'),
    3000: (1997, 'Formula Drift', '#777 Nissan 240SX', '1997 Formula Drift #777 Nissan 240SX'),
    3003: (2006, 'Formula Drift', '#43 Dodge Viper SRT-10 ACR', '2006 Formula Drift #43 Dodge Viper SRT-10 ACR'),
    3007: (2017, 'Volkswagen', '#34 Andretti Rally Cross Beetle', '2017 Volkswagen #34 Andretti Rally Cross Beetle'),
    3031: (1985, 'Porsche', '#185 959 Prodrive Rally Raid', '1985 Porsche #185 959 Prodrive Rally Raid'),
    3035: (2018, 'KTM', 'X-Bow GT4', '2018 KTM X-Bow GT4'),
    3037: (1989, 'Formula Drift', '#98 BMW 325i', '1989 Formula Drift #98 BMW 325i'),
    3051: (2017, 'Ford', 'M-Sport Fiesta RS', '2017 Ford M-Sport Fiesta RS'),
    3055: (2010, 'Jaguar', 'C-X75', '2010 Jaguar C-X75'),
    3062: (1970, 'Ferrari', '512 S', '1970 Ferrari 512 S'),
    3063: (2018, 'Mercedes-Benz', 'X-Class', '2018 Mercedes-Benz X-Class'),
    3064: (2018, 'Mercedes-AMG', 'GT 4-Door Coupé', '2018 Mercedes-AMG GT 4-Door Coupé'),
    3072: (2019, 'Porsche', '911 GT3 RS', '2019 Porsche 911 GT3 RS'),
    3082: (2008, 'Maserati', 'MC12 Versione Corsa', '2008 Maserati MC12 Versione Corsa'),
    3087: (2014, 'McLaren', '650S Spider', '2014 McLaren 650S Spider'),
    3088: (2018, 'DeBerti', 'Chevrolet Silverado 1500 Drift Truck', '2018 DeBerti Chevrolet Silverado 1500 Drift Truck'),
    3091: (2019, 'Aston Martin', 'Vantage', '2019 Aston Martin Vantage'),
    3107: (2014, 'Mercedes-Benz', 'G 63 AMG 6x6', '2014 Mercedes-Benz G 63 AMG 6x6'),
    3108: (2018, 'Ford', 'Mustang RTR Spec 5', '2018 Ford Mustang RTR Spec 5'),
    3110: (2013, 'DeBerti', 'Jeep Wrangler Unlimited', '2013 DeBerti Jeep Wrangler Unlimited'),
    3117: (2018, 'Porsche', '718 Cayman GTS', '2018 Porsche 718 Cayman GTS'),
    3118: (2019, 'Chevrolet', 'Corvette ZR1', '2019 Chevrolet Corvette ZR1'),
    3120: (2019, 'Lamborghini', 'Urus', '2019 Lamborghini Urus'),
    3123: (2019, 'Porsche', '911 Carrera S', '2019 Porsche 911 Carrera S'),
    3128: (2017, 'Ford', "#25 'Brocky' Ultra4 Bronco RTR", "2017 Ford #25 'Brocky' Ultra4 Bronco RTR"),
    3129: (2008, 'Renault', 'Mégane R26.R', '2008 Renault Mégane R26.R'),
    3132: (2018, 'MINI', 'X-raid John Cooper Works Buggy', '2018 MINI X-raid John Cooper Works Buggy'),
    3134: (2018, 'Renault', 'Megane R.S.', '2018 Renault Megane R.S.'),
    3141: (2019, 'Apollo', 'Intensa Emozione', '2019 Apollo Intensa Emozione'),
    3149: (2018, 'Chevrolet', 'Camaro ZL1 1LE', '2018 Chevrolet Camaro ZL1 1LE'),
    3153: (2018, 'McLaren', '600LT Coupé', '2018 McLaren 600LT Coupé'),
    3156: (2019, 'McLaren', 'Speedtail', '2019 McLaren Speedtail'),
    3170: (1994, 'Ford', 'Supervan 3', '1994 Ford Supervan 3'),
    3173: (2019, 'BMW', 'Z4 Roadster', '2019 BMW Z4 Roadster'),
    3176: (1987, 'Mercedes-Benz', 'AMG Hammer Coupe', '1987 Mercedes-Benz AMG Hammer Coupe'),
    3180: (1991, 'Peugeot', '205 Rallye', '1991 Peugeot 205 Rallye'),
    3184: (1977, 'Ford', '#5 Escort RS1800 MkII', '1977 Ford #5 Escort RS1800 MkII'),
    3185: (2019, 'Aston Martin', 'DBS Superleggera', '2019 Aston Martin DBS Superleggera'),
    3187: (2018, 'Porsche', 'Macan LPR Rally Raid', '2018 Porsche Macan LPR Rally Raid'),
    3189: (2019, 'Hennessey', 'Ford F-150 VelociRaptor 6X6', '2019 Hennessey Ford F-150 VelociRaptor 6X6'),
    3190: (2003, 'Ford', 'F-150 SVT Lightning', '2003 Ford F-150 SVT Lightning'),
    3198: (1984, 'De Tomaso', 'Pantera GT5', '1984 De Tomaso Pantera GT5'),
    3211: (2017, 'Aston Martin', 'Vulcan AMR Pro', '2017 Aston Martin Vulcan AMR Pro'),
    3212: (2019, 'Zenvo', 'TSR-S', '2019 Zenvo TSR-S'),
    3214: (2019, 'Porsche', '#70 Porsche Motorsport 935', '2019 Porsche #70 Porsche Motorsport 935'),
    3225: (2018, 'Ferrari', 'Portofino', '2018 Ferrari Portofino'),
    3226: (2017, 'Ferrari', 'J50 Preorder Car', '2017 Ferrari J50 Preorder Car'),
    3227: (2019, 'Ferrari', '488 Pista', '2019 Ferrari 488 Pista'),
    3228: (1999, 'Ford', 'Racing Puma', '1999 Ford Racing Puma'),
    3232: (2013, 'Formula Drift', '#777 Chevrolet Corvette', '2013 Formula Drift #777 Chevrolet Corvette'),
    3235: (1982, 'Volkswagen', 'Pickup LX', '1982 Volkswagen Pickup LX'),
    3241: (2018, 'Subaru', 'WRX STI ARX Supercar', '2018 Subaru WRX STI ARX Supercar'),
    3249: (2007, 'Formula Drift', '#117 599 GTB Fiorano', '2007 Formula Drift #117 599 GTB Fiorano'),
    3250: (2018, 'Mercedes-AMG', 'E 63 S', '2018 Mercedes-AMG E 63 S'),
    3255: (2020, 'Jeep', 'JT', '2020 Jeep JT'),
    3257: (1990, 'Nissan', 'Pulsar GTI-R', '1990 Nissan Pulsar GTI-R'),
    3277: (2020, 'Ford', 'Mustang Shelby GT500', '2020 Ford Mustang Shelby GT500'),
    3282: (1987, 'Porsche', '#203 Porsche AG 961', '1987 Porsche #203 Porsche AG 961'),
    3287: (1991, 'Jaguar', 'Sport XJR-15', '1991 Jaguar Sport XJR-15'),
    3288: (1993, 'Schuppan', '962CR', '1993 Schuppan 962CR'),
    3289: (2018, 'Lamborghini', 'Aventador SVJ', '2018 Lamborghini Aventador SVJ'),
    3293: (1993, 'Jaguar', 'XJ220S TWR', '1993 Jaguar XJ220S TWR'),
    3304: (1990, 'Alfa Romeo', 'SE 048SP', '1990 Alfa Romeo SE 048SP'),
    3307: (2019, 'Nissan', '370Z Nismo', '2019 Nissan 370Z Nismo'),
    3311: (2018, 'Ferrari', 'FXX-K Evo', '2018 Ferrari FXX-K Evo'),
    3312: (2019, 'Ferrari', 'Monza SP2', '2019 Ferrari Monza SP2'),
    3315: (2020, 'Koenigsegg', 'Jesko', '2020 Koenigsegg Jesko'),
    3318: (2018, 'Audi', 'RS 4 Avant', '2018 Audi RS 4 Avant'),
    3325: (2003, 'Aston Martin', 'DB7 GT', '2003 Aston Martin DB7 GT'),
    3359: (2021, 'Audi', 'RS e-tron GT', '2021 Audi RS e-tron GT'),
    3363: (1998, 'Nissan', '#23 Pennzoil NISMO Skyline GT-R', '1998 Nissan #23 Pennzoil NISMO Skyline GT-R'),
    3364: (2019, 'Aston Martin', 'Valhalla Concept Car', '2019 Aston Martin Valhalla Concept Car'),
    3367: (2019, 'Ferrari', 'F8 Tributo', '2019 Ferrari F8 Tributo'),
    3369: (2020, 'Chevrolet', 'Corvette Stingray Coupe', '2020 Chevrolet Corvette Stingray Coupe'),
    3371: (2020, 'Lamborghini', 'Huracán EVO', '2020 Lamborghini Huracán EVO'),
    3373: (2019, 'Toyota', '4Runner TRD Pro', '2019 Toyota 4Runner TRD Pro'),
    3374: (2019, 'Toyota', 'Tacoma TRD Pro', '2019 Toyota Tacoma TRD Pro'),
    3395: (1967, 'Renault', '8 Gordini', '1967 Renault 8 Gordini'),
    3400: (2009, 'Formula Drift', '#99 Mazda RX-8', '2009 Formula Drift #99 Mazda RX-8'),
    3402: (2020, 'Toyota', 'GR Supra', '2020 Toyota GR Supra'),
    3404: (2020, 'Ford', '#2069 Ford Performance Bronco R', '2020 Ford #2069 Ford Performance Bronco R'),
    3411: (1995, 'Formula Drift', '#34 Toyota Supra MkIV', '1995 Formula Drift #34 Toyota Supra MkIV'),
    3412: (2019, 'Subaru', 'STI S209', '2019 Subaru STI S209'),
    3413: (2021, 'Volkswagen', 'Golf R', '2021 Volkswagen Golf R'),
    3414: (2020, 'Land Rover', 'Defender 110 X', '2020 Land Rover Defender 110 X'),
    3434: (2020, 'BMW', 'M2 Competition Coupé', '2020 BMW M2 Competition Coupé'),
    3439: (2019, 'DeBerti', "Ford Super Duty F-250 Lariat 'Transformer'", "2019 DeBerti Ford Super Duty F-250 Lariat 'Transformer'"),
    3441: (2019, 'DeBerti', 'Toyota Tacoma TRD ‘The Performance Truck’', '2019 DeBerti Toyota Tacoma TRD ‘The Performance Truck’'),
    3445: (2020, 'Porsche', 'Taycan Turbo S', '2020 Porsche Taycan Turbo S'),
    3449: (2020, 'Lotus', 'Evija', '2020 Lotus Evija'),
    3454: (2020, 'Audi', 'RS 3 Sedan', '2020 Audi RS 3 Sedan'),
    3476: (2020, 'Ford', 'Super Duty F-450 DRW PLATINUM', '2020 Ford Super Duty F-450 DRW PLATINUM'),
    3477: (2020, 'Chevrolet', 'Silverado LT Trail Boss', '2020 Chevrolet Silverado LT Trail Boss'),
    3482: (2021, 'McLaren', '765LT Coupé', '2021 McLaren 765LT Coupé'),
    3494: (1968, 'Alfa Romeo', 'Autodelta Tipo 33/2 Daytona', '1968 Alfa Romeo Autodelta Tipo 33/2 Daytona'),
    3498: (2017, 'Saleen', 'S7 LM', '2017 Saleen S7 LM'),
    3518: (2020, 'BMW', 'M8 Competition Coupé', '2020 BMW M8 Competition Coupé'),
    3520: (2021, 'Lexus', 'LC 500', '2021 Lexus LC 500'),
    3523: (2020, 'Formula Drift', '#151 Toyota GR Supra', '2020 Formula Drift #151 Toyota GR Supra'),
    3524: (2019, 'Formula Drift', '#411 Toyota Corolla Hatchback', '2019 Formula Drift #411 Toyota Corolla Hatchback'),
    3533: (2022, 'Volkswagen', 'Golf R', '2022 Volkswagen Golf R'),
    3534: (2021, 'MINI', 'John Cooper Works GP', '2021 MINI John Cooper Works GP'),
    3539: (2020, 'SIERRA Cars', '#23 Yokohama ALPHA', '2020 SIERRA Cars #23 Yokohama ALPHA'),
    3540: (2021, 'SIERRA Cars', 'RX3', '2021 SIERRA Cars RX3'),
    3543: (2021, 'Pagani', 'Huayra R', '2021 Pagani Huayra R'),
    3548: (2013, 'Wuling', 'Sunshine S', '2013 Wuling Sunshine S'),
    3549: (2021, 'Alumicraft', '#122 Class 1 Buggy', '2021 Alumicraft #122 Class 1 Buggy'),
    3551: (2020, 'Formula Drift', '#91 BMW M2', '2020 Formula Drift #91 BMW M2'),
    3554: (2005, 'Mitsubishi', '#1 Sierra Sierra Enterprises Lancer Evolution Time Attack', '2005 Mitsubishi #1 Sierra Sierra Enterprises Lancer Evolution Time Attack'),
    3580: (2021, 'Aston Martin', 'DBX', '2021 Aston Martin DBX'),
    3583: (2021, 'Audi', 'RS 6 Avant', '2021 Audi RS 6 Avant'),
    3584: (2021, 'Audi', 'RS 7 Sportback', '2021 Audi RS 7 Sportback'),
    3590: (1972, 'Chevrolet', 'K-10 Custom', '1972 Chevrolet K-10 Custom'),
    3594: (2020, 'Ferrari', 'Roma', '2020 Ferrari Roma'),
    3595: (2020, 'Ferrari', 'SF90 Stradale', '2020 Ferrari SF90 Stradale'),
    3597: (1986, 'Ford', 'F-150 XLT Lariat', '1986 Ford F-150 XLT Lariat'),
    3599: (2020, 'Gordon Murray Automotive', 'T.50', '2020 Gordon Murray Automotive T.50'),
    3600: (2021, 'Hennessey', 'Venom F5', '2021 Hennessey Venom F5'),
    3603: (2019, 'Casey Currie Motorsports', "#4402 Ultra 4 'Trophy Jeep'", "2019 Casey Currie Motorsports #4402 Ultra 4 'Trophy Jeep'"),
    3604: (2020, 'Jimco', '#179 Hammerhead Class 1', '2020 Jimco #179 Hammerhead Class 1'),
    3605: (2019, 'Jimco', '#240 Fastball Racing Class 6100 Spec Trophy Truck', '2019 Jimco #240 Fastball Racing Class 6100 Spec Trophy Truck'),
    3606: (2020, 'Lamborghini', 'Essenza SCV12', '2020 Lamborghini Essenza SCV12'),
    3608: (2020, 'Lamborghini', 'Sián Roadster', '2020 Lamborghini Sián Roadster'),
    3611: (2022, 'Maserati', 'MC20', '2022 Maserati MC20'),
    3616: (2020, 'Mercedes-AMG', 'GT Black Series', '2020 Mercedes-AMG GT Black Series'),
    3617: (2021, 'Mercedes-AMG', 'SL 63', '2021 Mercedes-AMG SL 63'),
    3622: (2020, 'Nissan', 'GT-R NISMO (R35)', '2020 Nissan GT-R NISMO (R35)'),
    3625: (2021, 'Rimac', 'Nevera', '2021 Rimac Nevera'),
    3629: (2021, 'Toyota', 'GR Yaris', '2021 Toyota GR Yaris'),
    3631: (2022, 'Aston Martin', 'Valkyrie AMR Pro', '2022 Aston Martin Valkyrie AMR Pro'),
    3645: (2021, 'BMW', 'M4 Competition Coupé', '2021 BMW M4 Competition Coupé'),
    3650: (2021, 'Mercedes-AMG', 'Mercedes-AMG ONE', '2021 Mercedes-AMG Mercedes-AMG ONE'),
    3655: (2021, 'McLaren', '620R', '2021 McLaren 620R'),
    3657: (2022, 'Rivian', 'R1T', '2022 Rivian R1T'),
    3661: (2018, 'Lotus', 'Exige Cup 430', '2018 Lotus Exige Cup 430'),
    3662: (2021, 'RJ Anderson', '#37 Polaris RZR Pro 4 Truck', '2021 RJ Anderson #37 Polaris RZR Pro 4 Truck'),
    3665: (2021, 'SIERRA Cars', '700R', '2021 SIERRA Cars 700R'),
    3667: (2021, 'Porsche', '911 GT3', '2021 Porsche 911 GT3'),
    3668: (2023, 'McLaren', 'Artura', '2023 McLaren Artura'),
    3670: (2001, 'Ford', '#4 Ford Focus RS', '2001 Ford #4 Ford Focus RS'),
    3672: (2020, 'Lamborghini', 'Huracán STO', '2020 Lamborghini Huracán STO'),
    3678: (2020, 'Hyundai', 'i30 N', '2020 Hyundai i30 N'),
    3686: (2021, 'Polaris', 'RZR Pro XP Factory Racing Limited Edition', '2021 Polaris RZR Pro XP Factory Racing Limited Edition'),
    3687: (2021, 'Polaris', 'RZR Pro XP Ultimate', '2021 Polaris RZR Pro XP Ultimate'),
    3692: (2022, 'Ford', 'F-150 Lightning', '2022 Ford F-150 Lightning'),
    3693: (2022, 'Alumicraft', '#6165 Trick Truck', '2022 Alumicraft #6165 Trick Truck'),
    3698: (2021, 'Porsche', 'Mission R', '2021 Porsche Mission R'),
    3700: (2021, 'McLaren', 'Sabre', '2021 McLaren Sabre'),
    3716: (2023, 'Lotus', 'Emira', '2023 Lotus Emira'),
    3719: (2022, 'Cadillac', 'CT4-V Blackwing', '2022 Cadillac CT4-V Blackwing'),
    3720: (2022, 'Cadillac', 'CT5-V Blackwing', '2022 Cadillac CT5-V Blackwing'),
    3722: (2022, 'GMC', 'HUMMER EV Pickup', '2022 GMC HUMMER EV Pickup'),
    3724: (2022, 'Ferrari', '296 GTB', '2022 Ferrari 296 GTB'),
    3726: (2023, 'Acura', 'Integra A-Spec', '2023 Acura Integra A-Spec'),
    3728: (2021, 'Bentley', 'Continental GT Convertible', '2021 Bentley Continental GT Convertible'),
    3735: (2022, 'Subaru', 'BRZ', '2022 Subaru BRZ'),
    3736: (2022, 'Ford', 'Bronco Raptor', '2022 Ford Bronco Raptor'),
    3737: (2022, 'BMW', 'iX xDrive50', '2022 BMW iX xDrive50'),
    3744: (2023, 'Formula Drift', '#64 Forsberg Racing Nissan Z', '2023 Formula Drift #64 Forsberg Racing Nissan Z'),
    3745: (2020, 'Audi', 'R8 V10 performance', '2020 Audi R8 V10 performance'),
    3750: (1995, 'Mitsubishi', 'Montero Exceed 2800 TD', '1995 Mitsubishi Montero Exceed 2800 TD'),
    3753: (2022, 'Lamborghini', 'Huracán Tecnica', '2022 Lamborghini Huracán Tecnica'),
    3755: (2022, 'Ford', 'Supervan 4', '2022 Ford Supervan 4'),
    3759: (2022, 'Lamborghini', 'Huracán EVO Spyder', '2022 Lamborghini Huracán EVO Spyder'),
    3760: (2022, 'Porsche', '718 Cayman GT4 RS', '2022 Porsche 718 Cayman GT4 RS'),
    3761: (2022, 'Toyota', 'GR86', '2022 Toyota GR86'),
    3763: (2023, 'BMW', 'M2', '2023 BMW M2'),
    3764: (2022, 'BMW', 'M5 CS', '2022 BMW M5 CS'),
    3766: (2023, 'Chevrolet', 'Corvette Z06', '2023 Chevrolet Corvette Z06'),
    3767: (2022, 'Acura', 'NSX Type S', '2022 Acura NSX Type S'),
    3771: (2024, 'Chevrolet', 'Corvette E-Ray', '2024 Chevrolet Corvette E-Ray'),
    3773: (2023, 'Honda', 'Civic Type R', '2023 Honda Civic Type R'),
    3774: (2021, 'Lamborghini', 'Countach LPI 800-4', '2021 Lamborghini Countach LPI 800-4'),
    3775: (2022, 'Lamborghini', 'Aventador LP 780-4 Ultimae', '2022 Lamborghini Aventador LP 780-4 Ultimae'),
    3781: (2023, 'Porsche', '911 GT3 RS', '2023 Porsche 911 GT3 RS'),
    3783: (1989, 'Volkswagen', 'Rallye Golf', '1989 Volkswagen Rallye Golf'),
    3785: (1997, 'Toyota', 'Soarer 2.5 GT-T', '1997 Toyota Soarer 2.5 GT-T'),
    3789: (2022, 'Wuling', 'Hongguang Mini EV', '2022 Wuling Hongguang Mini EV'),
    3795: (2023, 'Meyers', 'Manx 2.0', '2023 Meyers Manx 2.0'),
    3798: (2017, 'Mazda', 'MX-5 Cup', '2017 Mazda MX-5 Cup'),
    3811: (2024, 'Lucid', 'Air Sapphire', '2024 Lucid Air Sapphire'),
    3819: (2022, 'Subaru', 'WRX', '2022 Subaru WRX'),
    3823: (2022, 'Mazda', 'MX-5 Miata RF', '2022 Mazda MX-5 Miata RF'),
    3827: (2023, 'Hyundai', 'IONIQ 5 N', '2023 Hyundai IONIQ 5 N'),
    3829: (2022, 'Hyundai', 'N Vision 74', '2022 Hyundai N Vision 74'),
    3840: (2022, 'Lamborghini', 'Huracán Sterrato', '2022 Lamborghini Huracán Sterrato'),
    3846: (2024, 'Ford', 'Mustang GT', '2024 Ford Mustang GT'),
    3847: (2024, 'Ford', 'Mustang Dark Horse', '2024 Ford Mustang Dark Horse'),
    3848: (2023, 'Toyota', 'Camry TRD', '2023 Toyota Camry TRD'),
    3849: (2023, 'Ford', 'F-150 Raptor R', '2023 Ford F-150 Raptor R'),
    3850: (2021, 'Dodge', 'Durango SRT Hellcat', '2021 Dodge Durango SRT Hellcat'),
    3851: (1991, 'Toyota', 'Sera', '1991 Toyota Sera'),
    3852: (1991, 'Honda', 'Beat', '1991 Honda Beat'),
    3854: (1993, 'Autozam', 'AZ-1', '1993 Autozam AZ-1'),
    3855: (1991, 'Nissan', 'Figaro', '1991 Nissan Figaro'),
    3856: (1987, 'Nissan', 'Be-1', '1987 Nissan Be-1'),
    3858: (1997, 'Nissan', 'Stagea RS Four V', '1997 Nissan Stagea RS Four V'),
    3859: (1984, 'Honda', 'City E II', '1984 Honda City E II'),
    3860: (1989, 'Nissan', 'S-Cargo', '1989 Nissan S-Cargo'),
    3865: (1994, 'Honda', 'Acty', '1994 Honda Acty'),
    3880: (2023, 'Toyota', 'GR Corolla', '2023 Toyota GR Corolla'),
    3886: (1995, 'Mitsubishi', 'Lancer Evolution III GSR', '1995 Mitsubishi Lancer Evolution III GSR'),
    3891: (2024, 'Lamborghini', 'Revuelto', '2024 Lamborghini Revuelto'),
    3895: (2020, 'Mercedes-AMG', 'SLC 43 Final Edition', '2020 Mercedes-AMG SLC 43 Final Edition'),
    3903: (2023, 'Ford', 'Fiesta ST', '2023 Ford Fiesta ST'),
    3904: (2022, 'Ford', 'Focus ST', '2022 Ford Focus ST'),
    3908: (2022, 'Honda', 'e', '2022 Honda e'),
    3910: (2023, 'Porsche', '911 Rallye', '2023 Porsche 911 Rallye'),
    3914: (1991, 'Toyota', 'Chaser GT Twin Turbo', '1991 Toyota Chaser GT Twin Turbo'),
    3917: (2023, 'Audi', 'R8 Coupé V10 GT RWD', '2023 Audi R8 Coupé V10 GT RWD'),
    3918: (1995, 'Nissan', 'Gloria Gran Turismo', '1995 Nissan Gloria Gran Turismo'),
    3921: (2024, 'Nissan', 'Z NISMO', '2024 Nissan Z NISMO'),
    3928: (2021, 'Hyundai', 'i20 N', '2021 Hyundai i20 N'),
    3929: (1989, 'Nissan', 'PAO', '1989 Nissan PAO'),
    3933: (1997, 'Toyota', 'Chaser 2.5 Tourer V', '1997 Toyota Chaser 2.5 Tourer V'),
    3937: (1970, 'Honda', 'N600', '1970 Honda N600'),
    3950: (1967, 'Ferrari', '275 GTB4 Spider', '1967 Ferrari 275 GTB4 Spider'),
    3953: (2023, 'Porsche', '911 Turbo S', '2023 Porsche 911 Turbo S'),
    3954: (2024, 'Chevrolet', 'Camaro ZL1', '2024 Chevrolet Camaro ZL1'),
    3955: (2024, 'Ram', '1500 TRX', '2024 Ram 1500 TRX'),
    3959: (2022, 'Dodge', 'Challenger SRT Super Stock', '2022 Dodge Challenger SRT Super Stock'),
    3960: (1994, 'Subaru', 'Vivio RX-R', '1994 Subaru Vivio RX-R'),
    3964: (2024, 'Toyota', 'Prius Prime XSE Premium', '2024 Toyota Prius Prime XSE Premium'),
    3983: (2024, 'BMW', 'X6 M Competition', '2024 BMW X6 M Competition'),
    3999: (2002, 'Nissan', 'Silvia Spec-R', '2002 Nissan Silvia Spec-R'),
    4002: (2024, 'Lamborghini', 'Temerario', '2024 Lamborghini Temerario'),
    4034: (1972, 'Honda', 'Z GT', '1972 Honda Z GT'),
    4038: (1999, 'Toyota', 'Altezza RS200 Z EDITION', '1999 Toyota Altezza RS200 Z EDITION'),
    4055: (1996, 'Toyota', 'Starlet Glanza V', '1996 Toyota Starlet Glanza V'),
    4057: (1997, 'Nissan', 'Skyline GT-R V-Spec', '1997 Nissan Skyline GT-R V-Spec'),
    4069: (1988, 'BMW', 'M3', '1988 BMW M3'),
    4081: (2024, 'Koenigsegg', 'Gemera', '2024 Koenigsegg Gemera'),
    4084: (1972, 'Datsun', "#269 Attacking the Clock Racing 240Z 'All Carbon Hill Climb Beast'", "1972 Datsun #269 Attacking the Clock Racing 240Z 'All Carbon Hill Climb Beast'"),
    4085: (1990, 'Mitsubishi', '#269 Attacking the Clock Racing Minicab Time Attack', '1990 Mitsubishi #269 Attacking the Clock Racing Minicab Time Attack'),
    4090: (2001, 'Mitsubishi', 'Lancer Evolution VI GSR TM Edition', '2001 Mitsubishi Lancer Evolution VI GSR TM Edition'),
    4094: (2024, 'Nissan', 'GT-R Nismo', '2024 Nissan GT-R Nismo'),
    4114: (1992, 'Nissan', 'Skyline GT-R', '1992 Nissan Skyline GT-R'),
    4119: (1998, 'Nissan', 'Skyline GT-R 40th Anniversary', '1998 Nissan Skyline GT-R 40th Anniversary'),
    4144: (1992, 'Mazda', 'RX-7 Type R', '1992 Mazda RX-7 Type R'),
    4145: (1974, 'Mazda', "#123 Mad Mike 808 Wagon 'FURSTY'", "1974 Mazda #123 Mad Mike 808 Wagon 'FURSTY'"),
    4147: (2021, 'Alfa Romeo', 'Giulia GTAm', '2021 Alfa Romeo Giulia GTAm'),
    4156: (2025, 'Ferrari', 'F80', '2025 Ferrari F80'),
    4158: (2010, 'Lexus', 'LFA Forza Edition', '2010 Lexus LFA Forza Edition'),
    4160: (1989, 'Nissan', 'S-Cargo Forza Edition', '1989 Nissan S-Cargo Forza Edition'),
    4162: (1985, 'Toyota', 'Sprinter Trueno GT Apex Forza Edition', '1985 Toyota Sprinter Trueno GT Apex Forza Edition'),
    4163: (2013, 'Wuling', 'Sunshine S Forza Edition', '2013 Wuling Sunshine S Forza Edition'),
    4164: (2022, 'Subaru', 'BRZ Forza Edition', '2022 Subaru BRZ Forza Edition'),
    4165: (1973, 'Mazda', 'RX-3 Forza Edition', '1973 Mazda RX-3 Forza Edition'),
    4166: (2023, 'BMW', 'M2 Forza Edition', '2023 BMW M2 Forza Edition'),
    4167: (2012, 'Nissan', 'GT-R Black Edition (R35) Forza Edition', '2012 Nissan GT-R Black Edition (R35) Forza Edition'),
    4168: (1968, 'Ford', 'Mustang GT 2+2 Fastback Forza Edition', '1968 Ford Mustang GT 2+2 Fastback Forza Edition'),
    4169: (1990, 'Mercedes-Benz', '190 E 2.5-16 Evolution II Forza Edition', '1990 Mercedes-Benz 190 E 2.5-16 Evolution II Forza Edition'),
    4171: (1986, 'Ford', 'F-150 XLT Lariat Forza Edition', '1986 Ford F-150 XLT Lariat Forza Edition'),
    4175: (2020, 'Ford', 'Super Duty F-450 DRW PLATINUM Forza Edition', '2020 Ford Super Duty F-450 DRW PLATINUM Forza Edition'),
    4179: (1990, 'Nissan', '#12 Skyline GT-R (BNR32 Gr.A) JTC', '1990 Nissan #12 Skyline GT-R (BNR32 Gr.A) JTC'),
    4197: (1994, 'Mazda', 'MX-5 Miata Forza Edition', '1994 Mazda MX-5 Miata Forza Edition'),
    4198: (1999, 'Dodge', 'Viper GTS ACR Forza Edition', '1999 Dodge Viper GTS ACR Forza Edition'),
    4199: (2019, 'Toyota', 'Tacoma TRD Pro Forza Edition', '2019 Toyota Tacoma TRD Pro Forza Edition'),
    4200: (2020, 'Lotus', 'Evija Forza Edition', '2020 Lotus Evija Forza Edition'),
    4205: (1972, 'Nissan', 'Patrol', '1972 Nissan Patrol'),
    4210: (2018, 'Lotus', 'Scura Motorsports Exige WTAC', '2018 Lotus Scura Motorsports Exige WTAC'),
    4211: (1990, 'Honda', '#19 101 Motorsport CRX WTAC', '1990 Honda #19 101 Motorsport CRX WTAC'),
    4212: (1993, 'Nissan', "#32 Skyline WTAC 'Xtreme GTR'", "1993 Nissan #32 Skyline WTAC 'Xtreme GTR'"),
    4213: (2000, 'Nissan', '#36 Dream Project S15 Silvia WTAC', '2000 Nissan #36 Dream Project S15 Silvia WTAC'),
    4214: (1995, 'Toyota', 'J&J Motorsport Supra WTAC', '1995 Toyota J&J Motorsport Supra WTAC'),
    4221: (2025, 'GR', 'GT Prototype', '2025 GR GT Prototype'),
    4222: (1989, 'Nissan', "Silvia K's", "1989 Nissan Silvia K's"),
    4223: (2000, 'Nissan', 'Skyline GT-R V Spec II', '2000 Nissan Skyline GT-R V Spec II'),
    4231: (2004, 'Honda', '#52 Evasive Motorsports S2000 WTAC', '2004 Honda #52 Evasive Motorsports S2000 WTAC'),
    4232: (2005, 'Porsche', 'Cayman GT3 WTAC', '2005 Porsche Cayman GT3 WTAC'),
    4234: (2008, 'Honda', 'Civic Type R (FD2)', '2008 Honda Civic Type R (FD2)'),
    4238: (1983, 'Nissan', 'Skyline 2000 Turbo RS', '1983 Nissan Skyline 2000 Turbo RS'),
    4254: (2001, 'Honda', '#33 Integra WTAC', '2001 Honda #33 Integra WTAC'),
    4255: (2005, 'Toyota', 'Crown Super Deluxe Taxi', '2005 Toyota Crown Super Deluxe Taxi'),
    4257: (2017, 'Toyota', 'JPN Taxi', '2017 Toyota JPN Taxi'),
    4259: (2013, 'Toyota', '86 Stories', '2013 Toyota 86 Stories'),
    4264: (2018, 'Ferrari', 'FXX-K Evo Welcome Pack', '2018 Ferrari FXX-K Evo Welcome Pack'),
    4265: (2020, 'Mercedes-AMG', 'GT Black Series Welcome Pack', '2020 Mercedes-AMG GT Black Series Welcome Pack'),
    4266: (2021, 'BMW', 'M4 Competition Coupé Welcome Pack', '2021 BMW M4 Competition Coupé Welcome Pack'),
    4267: (2004, 'Mitsubishi', 'Lancer Evolution VIII MR Welcome Pack', '2004 Mitsubishi Lancer Evolution VIII MR Welcome Pack'),
    4268: (2023, 'Ford', 'F-150 Raptor R Welcome Pack', '2023 Ford F-150 Raptor R Welcome Pack'),
    4277: (1992, 'Honda', '#21 Hardrace/JDMYard Civic WTAC', '1992 Honda #21 Hardrace/JDMYard Civic WTAC'),
    4278: (2025, 'Toyota', 'Land Cruiser', '2025 Toyota Land Cruiser'),
    4287: (1994, 'Subaru', 'Vivio RX-R Forza Edition', '1994 Subaru Vivio RX-R Forza Edition'),
    4313: (1970, 'Porsche', '#3 917 LH Forza Edition', '1970 Porsche #3 917 LH Forza Edition'),
    4315: (1962, 'Peel', 'P50 Trolli Edition', '1962 Peel P50 Trolli Edition'),
    4341: (2017, 'Ferrari', 'J50', '2017 Ferrari J50'),
    4342: (1965, 'Toyota', 'Sports 800 Fanta Edition', '1965 Toyota Sports 800 Fanta Edition'),
}
...
function updateFh6NavigatorUi() {{
  ensureFh6NavigatorTargetStillValid();
  let instance = currentFh6NavigatorInstance();
